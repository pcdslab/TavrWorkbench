...
#
# TavrWorkbenchParameterNode
#


@parameterNodeWrapper
class TavrWorkbenchParameterNode:
    """
...
class TavrWorkbenchWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
    ...
    def setParameterNode(self, inputParameterNode: TavrWorkbenchParameterNode | None) -> None:
        """
...
class TavrWorkbenchLogic(ScriptedLoadableModuleLogic):
    ...
    def getParameterNode(self):
        return TavrWorkbenchParameterNode(super().getParameterNode())
...
class TavrWorkbenchTest(ScriptedLoadableModuleTest):
    ...
    def test_TavrWorkbench1(self):
        ...
        registerSampleData()
        inputVolume = SampleData.downloadSample("TavrWorkbench1")
